export const PaymentIntrigityData = {
  // Class for general global variables.

  MRTitle: 'Medical Records Requested by UHC',
  CRTitle: 'Coding Review Results',
  MRRTitle: 'Medical Records Received vs. Awaiting Submission'
};
